...
public class Enemy {
        ...
        for(int i=0; i<b.length; i++){
            ...
            for (int j=0;j<b[0].length; j++){
                if(b[i][j].getId()!=0){
                    ...
                    //death
                    if(health<0) {x+=900; health =80; y=800;
                    }
                    }
                    }
                }
    ...
    public void draw(Graphics g){
        ...
        if(right&&!attack||left&&!attack){
            g.drawImage(Images.enemy[0],(int)x-400- (int)GameState.xOffset,(int)y,width+20,height+20,null);
